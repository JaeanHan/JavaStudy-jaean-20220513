...
public class CompanyMain {
	 ...
	 * 2. printCompanies() 메소드를 호출한 지점에서 예외를 처리한다.
	 * 3. NullPointerException 처리를 한다. 메세지 내용: 해당 주소에는 Company객체가 존재하지 않습니다.
	 * 4. finally에서 회사 정보 출력 완료.
	 * 
	 */
	
	public void printCompanies(ArrayList<Company> companies) throws NullPointerException {
		for(Company c : companies) {
//			if(c == null ) {
//				throw new NullPointerException("메세지 내용: 해당 주소에는 Company객체가 존재하지 않습니다.");
//			}
